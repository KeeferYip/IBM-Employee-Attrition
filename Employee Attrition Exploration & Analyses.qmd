...
\*In the following analyses, "new employees" refers to employees with short tenure.
...
Satisfaction groups are defined as:
...
We see that newer employees that have overtime are more likely to engage in attrition. However, I wanted to take it a step further by examining the satisfaction of these groups.
