...
```{r}
# Created a new table for employees who were at the company for less than a year
new_employees <- education_data %>%
  filter(years_at_company == 0) 
```
